...
class InterestsControllerTest < ActionController::TestCase
  ...
  test "should create interest" do
    assert_difference('Interest.count') do
      post :create, interest: { imagen: @interest.imagen, informacion: @interest.informacion, stakeholder_id: @interest.stakeholder_id, tema: @interest.tema }
    end
  ...
  test "should update interest" do
    patch :update, id: @interest, interest: { imagen: @interest.imagen, informacion: @interest.informacion, stakeholder_id: @interest.stakeholder_id, tema: @interest.tema }
    assert_redirected_to interest_path(assigns(:interest))
  end
