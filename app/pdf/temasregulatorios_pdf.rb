class TemasregulatoriosPdf < Prawn::Document
	def initialize(temasregulatorios,current_user)
	   	super()
	   	@current_user=current_user
	   	#@current_user=current_user
	   	imprimir(temasregulatorios.first)

	   	temasregulatorios.drop(1).each do |temasregulatorio|
