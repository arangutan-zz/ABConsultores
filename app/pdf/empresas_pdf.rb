class EmpresasPdf < Prawn::Document
	...
	def imprimir(empresa)
		...
		font "Times-Roman", :style => :normal
		#text empresa.created_at+"\n", :color => "4d4d4d"

			transparent(0.5) {}
		end

		bounding_box([420, cursor+23], :width => 120) do
			font "Times-Roman", :style => :bold
	...
	def displayImage(empresa)
		image Rails.root.to_s+"/public"+ empresa.imagen_url, :height => 150, :position => :center, :vposition => :top
	end
