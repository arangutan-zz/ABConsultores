class StakeholderPdf < Prawn::Document
	...
	def imprimir(stakeholder)
		...
		#End Fourth row
		y=cursor-25
		cell_1 = make_cell(:content => ''+stakeholder.perfil.upcase, :background_color => 'eaeaea', :align => :justify, :width=>515, :height=>150,  :text_color => "747474", :border_width=>0, :overflow => :truncate)
